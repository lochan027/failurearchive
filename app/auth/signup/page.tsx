      ...
      <div className="max-w-md mx-auto">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Join to submit failures and contribute knowledge
          </p>
        </div>
        ...
        <div className="space-y-3 mb-6">
          <button
            ...
            className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-900 flex items-center justify-center gap-3 transition-colors"
          >
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-blue-600"
